...
<div id="search" class="container-inline">
  <input class="search-input form-text" type="text" maxlength="128" name="search_theme_form" id="edit-search_theme_form" size="16" value="" title="<?php print t('Enter the terms you wish to search for.'); ?>" />
